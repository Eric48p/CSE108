    ...
    .then(function (data) {
        ...
        function renderTable(filteredData) {
            ...
            for (let i = 0; i < filteredData.length; i++) {
                ...
                editCell.innerHTML = '<button class="edit" onclick="editStudent(\'' + student.id + '\', \'' + student.name + '\')">Edit</button>';
                const deleteCell = row.insertCell();
                deleteCell.innerHTML = '<button class="delete" onclick="deleteStudent(\'' + student.id + '\', \'' + student.name + '\')">Delete</button>';
            }
        }
...
function editStudent(id, name) {
    ...
    nameInput.type = "text"
    nameInput.id = "studentName"
    nameInput.value = name // Set the value of the input to the key
